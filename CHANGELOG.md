...
## 0.24 — 2026-05-04 / upstream CodexBar 0.24 — 2026-05-06
...
## 0.8.0 — 2025-12-17
- TokenBar is now available via Homebrew: `brew install --cask tokenbar` (updates via `brew upgrade --cask tokenbar`).
