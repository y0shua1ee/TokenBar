...
public enum ClaudeOAuthKeychainPromptPreference {
    static let releaseApplicationDefaultsDomain = TokenBarIdentity.bundleIdentifier
    static let debugApplicationDefaultsDomain = TokenBarIdentity.debugBundleIdentifier
