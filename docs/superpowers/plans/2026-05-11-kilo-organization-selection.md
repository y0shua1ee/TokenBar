...
**Files:**
- Modify: `Sources/TokenBarCore/Config/CodexBarConfig.swift`
- Tests: covered indirectly via Task 6 SettingsStore tests.

- [ ] **Step 5.1: Add fields to `ProviderConfig`**

In `Sources/TokenBarCore/Config/CodexBarConfig.swift`, inside `public struct ProviderConfig`:
...
```bash
git add Sources/TokenBarCore/Config/CodexBarConfig.swift
