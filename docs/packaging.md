...
## Bundle contents
- `TokenBarWidget.appex` is built by `WidgetExtension/TokenBarWidgetExtension.xcodeproj` as a real macOS app extension, then bundled with app-group entitlements.
