...
- `Sources/TokenBarCore/Providers/CommandCode/` - descriptor, cookie import,
  billing fetcher, snapshot mapping, and plan catalog.
- `Sources/TokenBar/Providers/CommandCode/` - settings store bridge and
  provider settings UI.
- `Tests/TokenBarTests/CommandCode*Tests.swift` - parser, cookie, settings,
  and icon coverage.
