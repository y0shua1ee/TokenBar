...
- `Sources/TokenBarCore/Providers/StepFun/StepFunProviderDescriptor.swift` (descriptor + web fetch strategy)
- `Sources/TokenBarCore/Providers/StepFun/StepFunUsageFetcher.swift` (login flow + HTTP client + JSON parser)
- `Sources/TokenBarCore/Providers/StepFun/StepFunSettingsReader.swift` (env var resolution)
- `Sources/TokenBar/Providers/StepFun/StepFunProviderImplementation.swift` (settings fields + activation logic)
- `Sources/TokenBar/Providers/StepFun/StepFunSettingsStore.swift` (SettingsStore extension)
- `Tests/TokenBarTests/StepFunUsageFetcherTests.swift` (22 test cases)
