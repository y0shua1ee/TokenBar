...
Crof is API-only. TokenBar reads `GET https://crof.ai/usage_api/` with a
...
- Crof support said quota reset is around midnight Central time; TokenBar models this
...
- `Sources/TokenBarCore/Providers/Crof/`
- `Sources/TokenBar/Providers/Crof/`
- `Tests/TokenBarTests/CrofUsageFetcherTests.swift`
