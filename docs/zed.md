...
- `Sources/TokenBarCore/Providers/Zed/ZedStatusProbe.swift` - Keychain read, cloud API, snapshot mapping
- `Sources/TokenBarCore/Providers/Zed/ZedProviderDescriptor.swift` - provider metadata and local fetch strategy
- `Sources/TokenBar/Providers/Zed/ZedProviderImplementation.swift` - app registration
