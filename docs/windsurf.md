...
## Key files
- `Sources/TokenBarCore/Providers/Windsurf/WindsurfStatusProbe.swift` (local SQLite)
- `Sources/TokenBarCore/Providers/Windsurf/WindsurfDevinSessionImporter.swift` (Chromium localStorage extraction)
- `Sources/TokenBarCore/Providers/Windsurf/WindsurfWebFetcher.swift` (protobuf request + response parsing)
- `Sources/TokenBarCore/Providers/Windsurf/WindsurfProviderDescriptor.swift` (fetch strategies)
- `Sources/TokenBar/Providers/Windsurf/WindsurfProviderImplementation.swift` (settings UI)
- `Sources/TokenBar/Providers/Windsurf/WindsurfSettingsStore.swift` (settings persistence)
